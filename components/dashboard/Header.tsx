...
import { Bell, BellIcon, ChevronDown, MailQuestion, MenuIcon, Search } from 'lucide-react'
    ...
    return (
        <div className='w-full p-2 flex items-center justify-between border-b-2'>
            <div className='flex items-center gap-2'>
                ...
                <h1 className='text-[1.5rem] font-bold'>ProjeXess</h1>
            </div>
            <div className='flex p-1 items-center gap-7'>
                {
                    navLinks.map(link => (
            ...
            <div className='flex items-center gap-2'>
                <div className='flex items-center p-1 w-[200px] border-2 rounded-md'>
                ...
                <Button className='bg-white hover:bg-whit' size={'icon'}>
                    <MailQuestion className='bg-white text-black rotate-[45deg]' />
                </Button>
